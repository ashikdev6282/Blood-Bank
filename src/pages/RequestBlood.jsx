...
const RequestBlood = () => {
  ...
  const { createRequest } = useContext(BloodContext);
  ...
  // 📨 Submit blood request (saves to Firestore via context)
  const handleSubmit = async (e) => {
    ...
    // simple validation
    if (!form.name || !form.bloodGroup || !form.hospital || !form.contact) {
    ...
    if (!/^[A-Za-z\s]+$/.test(form.hospital)) {
      setError("Hospital name should contain only letters and spaces.");
      setSubmitting(false);
      return;
    }
  ...
  return (
    <div className={darkMode ? "dark-mode request-page" : "request-page"}>
        ...
        <Row className="align-items-center hero-request" data-aos="fade-up">
          <Col md={6} className="hero-text" data-aos="fade-right">
            ...
            <p className="hero-subtitle">
              Connect instantly with donors and save precious lives in critical
              situations.
            </p>
          </Col>
          <Col md={6}>
            <img
              src={bloodRequestImage}
              alt="Blood Request"
              className="img-fluid request-hero-img"
              data-aos="fade-left"
            />
          </Col>
        </Row>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${bloodSlideImage})`,
          borderRadius: "40px",
        }}
      >
        <Container className="py-5">
          <Row
            className="align-items-center glass-form-wrapper"
            data-aos="fade-up"
          >
            <Col md={6} className="form-side-content text-white">
              <h3 className="mb-3">Submit Your Request</h3>
              <p>
                Help is just a few steps away. Submit your blood request and our
                network will assist you right away.
              </p>
            </Col>
            <Col md={6}>
              <Form
                className="request-form p-4 glassmorphic-form"
        ...
        <Row className="g-4 text-center">
          <Col md={4}>
            <div className="step-card">
              ...
              <p>
                Complete the blood request form with patient and hospital
                details.
              </p>
            </div>
          </Col>
          <Col md={4}>
            <div className="step-card">
              ...
              <p>
                Our team will call you immediately to verify the urgency and
                details.
              </p>
            </div>
          </Col>
          <Col md={4}>
            <div className="step-card">
              <h5>🩸 Find Donors</h5>
              <p>
                We’ll match you with nearby available donors or guide you
                further.
              </p>
            </div>
          </Col>
          ...
          {[
            ...
            <Col key={index} xs={6} md={3}>
              <div className="impact-box" style={{ borderColor: stat.color }}>
                ...
                <h3 className="count-up" data-target={stat.value}>
                  0
                </h3>
                <p>{stat.title}</p>
              </div>
          ...
          {[
            ...
            <Col md={4} key={index} data-aos="zoom-in">
              <Card
                ...
                style={{
                  borderRadius: "20px",
                  backgroundColor: "rgb(220, 141, 141)",
                }}
              >
                <Card.Body>
          ...
          <Carousel indicators={false} interval={6000}>
            <Carousel.Item>
              <p className="testimonial-text">
                “In a time of crisis, this platform helped us find a donor in
                minutes. Forever grateful!”
              </p>
              <p className="testimonial-author">– Ramesh, Chennai</p>
            </Carousel.Item>
            <Carousel.Item>
              <p className="testimonial-text">
                “It’s efficient, reliable, and life-saving. Found rare blood for
                my son through this.”
              </p>
            ...
            <Carousel.Item>
              <p className="testimonial-text">
                “The 24/7 helpline truly works. Got connected with a donor
                within an hour.”
              </p>
            ...
            <Carousel.Item>
              <p className="testimonial-text">
                “Impressed by the quick response and professional support.
                Highly recommend!”
              </p>
